...
ActiveRecord::Schema.define(version: 20171010050747) do
  ...
  create_table "spree_bookkeeping_documents", id: :serial, force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["printable_type", "printable_id"], name: "index_printable_type_and_printable_id"
  end
  ...
  create_table "spree_subscription_events", id: :serial, force: :cascade do |t|
    ...
    t.index ["subscription_id"], name: "index_spree_subscription_events_on_subscription_id"
  end
  ...
  create_table "spree_subscriptions", id: :serial, force: :cascade do |t|
    ...
    t.index ["plan_id"], name: "index_spree_subscriptions_on_plan_id"
    t.index ["subscribed_at"], name: "index_spree_subscriptions_on_subscribed_at"
    t.index ["unsubscribed_at"], name: "index_spree_subscriptions_on_unsubscribed_at"
  end
